...
const INTERVAL_KEYS_OUTPUT = INTERVAL_ROAD_ADDRESS_KEYS_OUTPUT.concat(INTERVAL_COORDINATE_KEYS);

const POINT_DAYS_KEYS = ROAD_ADDRESS_KEYS.concat(OTHER_DAYS_KEYS);
const POINT_DAYS_KEYS_OUTPUT = ROAD_ADDRESS_KEYS_OUTPUT.concat(OTHER_DAYS_KEYS).concat(ROAD_ADDRESS_KEYS_OUT);
