...
const POINT_KEYS_OUTPUT = COORDINATE_KEYS.concat(ROAD_ADDRESS_KEYS_OUTPUT).concat(STREET_ADDRESS_KEYS_OUTPUT).concat(OTHER_ADDRESS_KEYS);
const POINT_KEYS_OUTPUT_FOR_ROADADDRESS = COORDINATE_KEYS.concat(ROAD_ADDRESS_KEYS).concat(STREET_ADDRESS_KEYS_OUTPUT).concat(OTHER_ADDRESS_KEYS);
...
function buildOutput(data) {
  ...
  }else if(byRoadAddress){
	keys = POINT_KEYS_OUTPUT_FOR_ROADADDRESS;
